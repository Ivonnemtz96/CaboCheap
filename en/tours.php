                                ...
                                <div class="trend-content p-4 pt-5 position-relative">
                                    <div class="trend-meta bg-theme white px-3 py-2 rounded">
                                        <div class="entry-author">
                                            ...
                                            <span class="fw-bold"> <?php echo ($tour['duracion']); ?> hours</span>
                                        </div>
                                    </div>
                                    <h5 class="theme mb-1"><i class="flaticon-location-pin"></i> <?php echo ($catSel['nombreIn']); ?></h5>
                                    <h3 class="mb-1"><a href="/tour?id=<?php echo ($tour['id']); ?>"><?php echo ($tour['nombre_ingles']); ?></a></h3>
                                    ...
                                    <p class=" border-b pb-2 mb-2"><?php echo substr(strip_tags($tour['descripcion_ingles']), 0, 130); ?>...</p>
