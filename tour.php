    ...
    <div class="banner trending overflow-hidden">
                        ...
                        <div class="col-lg-5 p-0">
                            <div class="trend-item1 box-shadow bg-white text-center">
                                <div class="trend-image position-relative">
                                    <img src="/upload/tours/<?php echo (strftime("%Y/%m", strtotime(($tour['fr'])))); ?>/<?php echo ($foto['codigo']) ?>.jpg" alt="image" class="">
        ...
        <div class="banner-breadcrum position-absolute top-50 mx-auto w-50 start-50 text-center translate-middle">
            <div class="breadcrumb-content text-center">
                <h1 class="mb-0 white"><?php echo $tour['nombre']; ?></h1>
                    ...
                    <div class="single-content">
                        <div id="highlight">
                            ...
                            <div class="description-images mb-4">
                                <img src="/upload/tours/<?php echo (strftime("%Y/%m", strtotime(($tour['fr'])))); ?>/<?php echo ($tour['fPortada']) ?>.jpg" alt="" class="w-100 rounded">
                            </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 mb-2">
                                        <div class="desc-box bg-grey p-4 rounded">
                                            ...
                                            <ul>
                                                ...
                                                ?>
                                                        <li class="d-block pb-1"><i class="fa fa-circle pink mr-1"></i> <?php echo $carSel['descripcion']; ?></li>
                                                <?php
                                                    }
                                                }
                                                ?>
                                ...
                                <div class="col-lg-6 col-md-6 mb-2">
                                    <div class="desc-box bg-grey p-4 rounded">
                                        ...
                                        <ul>
                                            ...
                                            ?>
                                                    <li class="d-block pb-1"><i class="fa fa-check pink mr-1"></i> <?php echo $carSel['descripcion']; ?></li>
                                            <?php
                                                }
                                            }
                                            ?>
                                ...
                                <div class="col-lg-6 col-md-6 mb-2">
                                    <div class="desc-box bg-grey p-4 rounded">
                                        ...
                                        <ul>
                                            ...
                                            ?>
                                                    <li class="d-block pb-1"><i class="fa fa-close pink mr-1"></i> <?php echo $carSel['descripcion']; ?></li>
                                            <?php
                                                }
                                            }
                                            ?>
                ...
                <div class="col-lg-4 ps-lg-4">
                    <div class="sidebar-sticky">
                        <div class="list-sidebar">
                            ...
                            <form method="POST" action="/detalles/" class="form-content rounded overflow-hidden bg-title">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group mb-0">
                                                <button type="submit" name="submit" value="submit" class="nir-btn w-100">Enviar</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-6 mb-4">
                                                    <div class="trend-item1">
                                                        <div class="trend-image position-relative rounded">
                                                            <img src="/upload/tours/<?php echo (strftime("%Y/%m", strtotime(($tour['fr'])))); ?>/<?php echo ($tour['fPortada']) ?>.jpg" alt="image">
                                                            <div class="trend-content d-flex align-items-center justify-content-between position-absolute bottom-0 p-4 w-100 z-index">
                                                                <div class="trend-content-title">
                                                                    <h5 class="mb-0"><a href="/tour?id=<?php echo ($tour['id']); ?>" class="theme1"><?php echo ($catSel['nombre']); ?></a></h5>
