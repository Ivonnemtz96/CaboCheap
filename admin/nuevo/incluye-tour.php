...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	...
	if($descripcion==""){
		...
		header('location:/admin/nuevo/incluye-tour');
		exit;
	}else{
        
		$caractCount	=	$db->getQueryCount('toursIncluye','id');
		if($caractCount[0]['total']<10000){
			$data	=	array(
							'descripcion'=>($descripcion),
                            
						);
			$insert	=	$db->insert('toursIncluye',$data);
			if($insert){
                setcookie("msg","carok",time() + 2, "/");
				header('location:/admin/nuevo/incluye-tour');//exito
				exit;
			}else{
                setcookie("msg","ups",time() + 2, "/");
				header('location:/admin/nuevo/incluye-tour');//sin cambios
				exit;
			}
		} else{
            setcookie("msg","lim",time() + 2, "/");
			header('location:/admin/nuevo/incluye-tour'); //limite
			exit;
		}
	}
}
      ...
      <div class="main-content">
            ...
            <div class="col-md-12 col-lg-12 col-xl-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4>Agregar una característica nueva (Incluye en tour)</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 col-xl-12">
                <div class="card">
                    <div class="card-header">
                      <h4>Todas las características actuales (Incluye en tour)</h4>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped" id="table-1">
                                ...
                                <tbody>
                                <?php $caracteristicasData = $db->getAllRecords('toursIncluye','*','ORDER BY descripcion ASC');
                                      ...
                                      $y	=	'';
                                          foreach($caracteristicasData as $caracteristicas){
                                              ...
                                              <tr>
                                                  ...
                                                  <td class="text-rigth">
                                                      <a href="/admin/editar/incluye-tour?editId=<?php echo $caracteristicas['id']; ?>" class="btn btn-icon btn-primary"><i class="far fa-edit"></i></a>
                                                      <a href="/admin/borrar/incluye-tour?delId=<?php echo $caracteristicas['id']; ?>" onClick="return confirm('Estás seguro? Esto no se puede deshacer');" class="btn btn-icon btn-danger"><i class="fa fa-trash"></i></a>
                                                  </td>
                                              </tr>
