...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
    ...
    if ($descripcion==""){
		...
		$tariCount	=	$db->getQueryCount('toursItinerario','id');
		if($tariCount[0]['total']<1000){
			...
			if($insert){
				...
				header('location:/admin/nuevo/itinerario-tour?tourId='.($tour['id']).'');//exito
				exit;
			}else{
      ...
      <div class="main-content">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                      <h4>Agrega itinerarios para - Tour - <?php echo ($tour['nombre'])?></h4>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                      <h4>Itinerario para - Tour - <?php echo ($tour['nombre'])?></h4>
                    </div>
                    <div class="card-body">
